...
-- --- PÁGINAS CON COLORES PERSONALIZADOS ---
...
-- AÑADIDO: Transcendant
TeleportPage:Section('Transcendant')
TeleportPage:Button({
    Title = 'Teleport Transcendant',
    Desc = 'Teleport to the Transcendant Area',
    Text = 'TP',
    Callback = function()
        teleportToPosition(-234, 150060, -35)
    end,
})
